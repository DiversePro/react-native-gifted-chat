...
import { Platform, StyleSheet, View, SafeAreaView, KeyboardAvoidingView, Keyboard, } from 'react-native';
...
class GiftedChat extends React.Component {
    constructor(props) {
        ...
        this.keyboardWillShow = () => {
            if (this.state.position !== 'relative') {
                ...
                this.props.setIsKeyboardOpen(true);
            }
        };
        this.keyboardWillHide = () => {
            if (this.state.position !== 'absolute') {
                ...
                if(this.props.setIsKeyboardOpen){
                    this.props.setIsKeyboardOpen(false);
                }
            }
        };
    ...
    componentWillUnmount() {
        ...
        console.log("Unmounting",this.keyboardWillShowListener,this.keyboardWillHideListener)
    ...
    renderMessages() {
        ...
        <MessageContainer {...messagesContainerProps} invertibleScrollViewProps={this.invertibleScrollViewProps} messages={this.getMessages()} forwardRef={this._messageContainerRef} isTyping={this.props.isTyping } position={this.state.position} isReplyActive={this.props.isReplyActive}/>
...
GiftedChat.propTypes = {
    blur:PropTypes.bool,
    setIsKeyboardOpen:PropTypes.any,
