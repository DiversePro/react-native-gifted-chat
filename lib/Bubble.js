...
export default class Bubble extends React.Component {
    ...
    renderUsername() {
        const { currentMessage,nextMessage, user,renderUsernameOnMessage } = this.props;
        ...
        if (
            ...
            isSameDay(currentMessage, messageToCompare) && !isUnreadStarted(currentMessage,messageToCompare,user)) || (user && currentMessage.user._id === user._id) || currentMessage.file_type== 'post1' || !!currentMessage.image || !!currentMessage.video || currentMessage.file_type== 'pdf1')
        {
