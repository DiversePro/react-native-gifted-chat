...
export default class Bubble extends React.Component {
    ...
    render() {
        ...
        <View style={[
            ...
            !currentMessage.image && !currentMessage.video && currentMessage?.fileType != 'pdf' && currentMessage?.fileType != 'story' && currentMessage?.fileType != 'storyReaction' && currentMessage?.fileType != 'storyReply'  && currentMessage?.fileType != 'communityInvite' && currentMessage?.fileType != 'storyMention'  && wrapperStyle && wrapperStyle[position],
            {overflow:(currentMessage?.fileType?.includes("story") && !currentMessage?.story) || (currentMessage?.fileType == "post" && !currentMessage?.post) ?"visible" : 'hidden'},
