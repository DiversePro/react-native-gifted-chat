...
export default class Bubble extends React.Component {
    ...
    renderTicks() {
        ...
        if (currentMessage &&
            user &&
            currentMessage.user &&
            currentMessage?.createdBy?.attorneyId !== user.id) {
            return null;
        }
        if (currentMessage &&
    ...
    renderUsername() {
        const { currentMessage,previousMessage, user,renderUsernameOnMessage,nextMessage } = this.props;
        ...
        if (
            ...
            isSameDay(currentMessage, messageToCompare) && !isUnreadStarted(currentMessage,messageToCompare,user)) || (user && currentMessage?.createdBy?.attorneyId === user.id) || currentMessage.fileType== 'post' || !!currentMessage.image || !!currentMessage.video || currentMessage.fileType== 'pdf' || currentMessage.fileType== 'story' || currentMessage.fileType== 'storyReaction' || currentMessage.fileType== 'storyReply' || currentMessage.fileType== 'storyMention')
        {
    ...
    render() {
        ...
        <View style={[
            ...
            !currentMessage.image && !currentMessage.video && currentMessage?.fileType != 'pdf' && currentMessage?.fileType != 'story' && currentMessage?.fileType != 'storyReaction' && currentMessage?.fileType != 'storyReply' && currentMessage?.fileType != 'storyMention'  && currentMessage?.fileType != 'communityInvite'  && currentMessage?.fileType != 'community' && currentMessage?.fileType != 'profile'&&   wrapperStyle && wrapperStyle[position],
            currentMessage?.fileType == 'community'  && currentMessage?.community &&  wrapperStyle && wrapperStyle[position],
            currentMessage?.fileType == 'profile'  && currentMessage?.profile &&  wrapperStyle && wrapperStyle[position],
            (currentMessage.image || currentMessage.video || currentMessage.post) && {overflow:'hidden'},
