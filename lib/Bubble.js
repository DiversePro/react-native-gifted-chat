...
export default class Bubble extends React.Component {
    ...
    styledBubbleToPrevious() {
        const { currentMessage, previousMessage, position, containerToPreviousStyle,nextMessage } = this.props;
       
        if (!isSameDay(currentMessage, nextMessage) ||  !isSameUser(currentMessage, nextMessage))
           {
            return [
    ...
    renderUsername() {
        ...
        if (
            ...
            isSameDay(currentMessage, messageToCompare)) || (user && currentMessage.user._id === user._id) || currentMessage.file_type== 'post' || !!currentMessage.image || !!currentMessage.video || currentMessage.file_type== 'pdf')
        {
