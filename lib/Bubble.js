...
export default class Bubble extends React.Component {
    ...
    renderUsername() {
        ...
        if (
            ...
            isSameDay(currentMessage, messageToCompare) && !isUnreadStarted(currentMessage,messageToCompare,user)) || (user && currentMessage.createdBy?.attorneyId === user.id) || currentMessage.fileType== 'post' || !!currentMessage.image || !!currentMessage.video || currentMessage.fileType == 'pdf')
        {
    ...
    render() {
        ...
        <View style={[
            ...
            !currentMessage.image && !currentMessage.video && currentMessage?.fileType != 'pdf' && wrapperStyle && wrapperStyle[position],
